...

        {
            ...
            if (presence != nullptr) {
                ...
                if (!presence->buttons) {
                    ...
                    if (btns[1].label && btns[1].label[0]) {
...
size_t JsonWriteOpenOverlayActivityInvite(char* dest, size_t maxLen, int8_t type, int nonce, int pid)
{
    JsonWriter writer(dest, maxLen);
...
size_t JsonWriteOpenOverlayGuildInvite(char* dest, size_t maxLen, const char* code, int nonce, int pid)
{
    JsonWriter writer(dest, maxLen);
